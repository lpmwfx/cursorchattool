...
class ChatBrowser {
  ...
  Future<void> listChats() async {
    ...
    for (var i = 0; i < _chats.length; i++) {
      ...
      // Logger requestId til diagnostik
      if (chat.requestId.isNotEmpty) {
        print('Chat #${i+1} har requestId: ${chat.requestId}');
      }
      
      print('${i + 1} | ${displayTitle} | $dateStr | ${chat.messages.length}');
    }
